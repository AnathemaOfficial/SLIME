...
# Security & Vulnerability Disclosure — SLIME-Core
...
Canonical execution membrane specifications (specs/) and reference Rust runner (noncanon/). Reports concerning specification ambiguity, runner divergence from specs, or membrane bypass are in scope.
